...
func (s *RoutingTable) Ping(ctx context.Context, req *PING) (*ACK, error) {
	// update routing: note the peer is alive
	s.Update(ctx, req.From)
	return &ACK{From: s.GetLocal(), Value: req.Value}, nil
}

// Store is a placeholder: you can hook in a DHT put here.
func (s *RoutingTable) Store(ctx context.Context, req *STORE) (*ACK, error) {
...
func (s *RoutingTable) Delete(ctx context.Context, req *DELETE) (*ACK, error) {
	// TODO: integrate with persistent storage delete
	s.Update(ctx, req.From)
	return &ACK{From: s.GetLocal(), Value: nil}, nil
}

// FindNode returns up to k closest contacts to target_id.
func (s *RoutingTable) FindNode(ctx context.Context, req *FIND_NODE) (*NODES, error) {
	s.Update(ctx, req.From)
...
func (s *RoutingTable) FindValue(ctx context.Context, req *FIND_VALUE) (*VALUE, error) {
	s.Update(ctx, req.From)
...
func (s *RoutingTable) Refresh(ctx context.Context, req *REFRESH) (*ACK, error) {
	s.Update(ctx, req.From)
